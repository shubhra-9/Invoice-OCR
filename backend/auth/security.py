...
# this is for internal use in python which can hold either hold the instance of PyJWKClient initialized to none   
...
def _verify_clerk_token(token: str) -> dict:
    ...
    try:
        ...
        signing_key = jwks_client.get_signing_key_from_jwt(token)#gets the important portion from token generated by frontend
        decoded = jwt.decode(
            token,
            signing_key.key,
